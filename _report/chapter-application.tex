...
\begin{itemize}
	\item Skeleton basic view, by reading directly from file without modifications except vtkContourFilter (key "1")
	\item Skeleton tubed view, as above but vtkTubeFilter is used (key "2")
	\item Skeleton colored view (key "3")
	\item Skeleton varying radius view (key "4")
	\item Volume visualization (key "5")
	\item Segmented view (key "6")
\end{itemize}
